...
class AuditorPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->widgets([
                // Widget dikosongkan agar tidak dobel
                // Tambahkan custom widget via Dashboard::getWidgets() jika perlu
            ])
            ->middleware([
    ...
    private function getStyles(): string
    {
        ...
        <style>
            ...
            /* ════════════════════════════════════════════════
               LIGHT MODE  (Filament: no .dark on <html>)
            ════════════════════════════════════════════════ */
            html:not(.dark) {
                --mg-surface-0:      #F8F8F4;
                --mg-surface-1:      #FFFFFF;
                ...
                /* Darker accent for light-bg readability */
                --mg-accent-current: #7A8C2E;
            }

            /* ════════════════════════════════════════════════
               DARK MODE  (Filament: .dark on <html>)
            ════════════════════════════════════════════════ */
            html.dark {
                --mg-surface-0:      #0C0C0C;
                --mg-surface-1:      #111111;
            ...
            /* User area at the bottom of sidebar */
            .fi-sidebar-footer {
            ...
            /* ════════════════════════════════════════════════
               ACCOUNT WIDGET (bawaan Filament)
            ════════════════════════════════════════════════ */
            .fi-wi-account {
                border-radius: var(--card-radius) !important;
                border: 1px solid var(--mg-border-subtle) !important;
            ...
            .fi-wi-account .fi-avatar {
                border: 2px solid var(--mg-accent-current) !important;
            }
