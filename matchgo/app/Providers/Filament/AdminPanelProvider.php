...
class AdminPanelProvider extends PanelProvider
{
    ...
    private function getDashboardStyles(): string
    {
        ...
        <style>
            ...
            .fi-section, .fi-wi-table, .fi-wi-stats-overview-stat { background: var(--surface-1) !important; border: 1px solid var(--border-subtle) !important; border-radius: var(--card-radius) !important; box-shadow: var(--card-shadow) !important; }
            .fi-wi-stats-overview-stat { transition: transform .2s ease, box-shadow .2s ease, border-color .2s !important; position: relative; overflow: hidden; }
            .fi-wi-stats-overview-stat::after { content: ""; position: absolute; top: 0; left: 0; right: 0; height: 2px; background: linear-gradient(90deg, var(--accent-current) 0%, transparent 75%); }
            ...
            .fi-dropdown-list-item { border-radius: 8px !important; font-size: .825rem !important; font-family: 'Inter', sans-serif !important; color: var(--txt-secondary) !important; }
