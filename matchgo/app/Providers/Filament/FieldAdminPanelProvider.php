...
class FieldAdminPanelProvider extends PanelProvider
{
    ...
    private function getDashboardStyles(): string
    {
        ...
        <style>
            /* ═══════════════════════════════════════════
               CSS VARIABLES — seragam dengan dashboard user
            ═══════════════════════════════════════════ */
            :root {
                --accent:         #A3B14B;
                --accent-hover:   #8f9c40;
            ...
            .fi-header-heading, .fi-logo, .fi-wi-stats-overview-stat-value {
            ...
            .fi-sidebar-item-active .fi-sidebar-item-icon { color: var(--accent-current) !important; }
            ...
            .fi-wi-stats-overview-stat-label {
                font-size: .725rem !important; font-weight: 500 !important;
            ...
            .fi-ta-header-cell {
                font-size: .725rem !important; font-weight: 600 !important;
            ...
            .fi-ta-row td {
                ...
                font-size: .875rem !important; color: var(--txt-secondary) !important;
                border-bottom: 1px solid var(--border-subtle) !important;
            ...
            *::-webkit-scrollbar-thumb:hover { background: rgba(163,177,75,0.4); }
            ...
            ═══════════════════════════════════════════ */
            *:focus-visible {
                outline: 2px solid var(--accent-current) !important;
                outline-offset: 2px !important;
            }

            /* ═══════════════════════════════════════════
               WIDGET WRAPPER — hilangkan background default Filament
               agar widget blade kita yang kontrol penuh
            ═══════════════════════════════════════════ */
            .fi-wi-view {
